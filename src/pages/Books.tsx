          ...
          <p className="text-sm text-muted-foreground mb-6">
            ...
            {(() => {
              ...
              if (t.lang === 'ru') {
                ...
                if (mod10 === 1 && mod100 !== 11) return t.catalog.book_singular;
                if (mod10 >= 2 && mod10 <= 4 && (mod100 < 12 || mod100 > 14)) return t.catalog.book_few;
                return t.catalog.book_plural;
              }
              return count === 1 ? t.catalog.book_singular : t.catalog.book_plural;
            })()}
