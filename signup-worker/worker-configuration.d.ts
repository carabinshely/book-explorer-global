/* eslint-disable */
// Generated by Wrangler by running `wrangler types signup-worker/worker-configuration.d.ts --config signup-worker/wrangler.jsonc --env preview --strict-vars false` (hash: 6f0edb43e14fa54ca40194a56d35efbb)
// Runtime types generated with workerd@1.20250816.0 2026-08-20 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		MAILERLITE_DELIVERY_GROUP_ID: string;
		MAILERLITE_MARKETING_GROUP_ID: string;
		MAILERLITE_PENDING_MARKETING_GROUP_ID: string;
		NIRAN_CONSENT_VERSION: string;
		SIGNUP_ENVIRONMENT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAILERLITE_DELIVERY_GROUP_ID" | "MAILERLITE_MARKETING_GROUP_ID" | "MAILERLITE_PENDING_MARKETING_GROUP_ID" | "NIRAN_CONSENT_VERSION" | "SIGNUP_ENVIRONMENT" | "SIGNUP_ENABLED" | "MAILERLITE_API_TOKEN">> {}
}
